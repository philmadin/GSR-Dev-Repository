...
$query_user_arts = "SELECT id, article_type, title, author, month, images, views, createdate, bites FROM tbl_guide WHERE authuser = ? AND alpha_approved = 'true' ORDER BY createdate DESC LIMIT 9 OFFSET " .  $offset . ";";
