<?php
	...
	$articleQRY = mysqli_query($con, "SELECT * FROM tbl_news WHERE id = '$getArticle'");
				...
				<form class="grid_18 grid_0 submitform" id="submitform" method="get" action="" enctype="multipart/form-data">
				    ...
				    <p class="scroll_section" id="type_section" style="display:none;">
				        ...
				        <select id="articletype" name="articletype">
				            <option value="News" selected>News Article</option>
				        </select>
				    </p>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$("#confirm").on('click', function(event) {
				$.ajax({
			        url : "submitnews.php?deletionid=" + $(this).val(),
			        type : "GET",
			        dataType: "html",
			        async : false,
			        success: function(data) {
			            document.location = "articlelist.php?type=news";
			        }
			    });
			});
			...
			$("#deny").on('click', function(event) {
				$.ajax({
			        url : "submitnews.php?deny=" + $(this).val(),
			        type : "GET",
			        dataType: "html",
			        async : false,
			        success: function(data) {
