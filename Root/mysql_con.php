...
$query_user_art_info = "SELECT id, views, bites FROM tbl_review WHERE authuser = ? UNION SELECT id, views, bites FROM tbl_guide WHERE authuser = ? UNION SELECT id, views, bites FROM tbl_news WHERE authuser = ? UNION SELECT id, views, bites FROM tbl_opinion WHERE authuser = ?";
