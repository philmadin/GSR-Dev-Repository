...
if ($articleviews == 1) {
    $articleviewtext = "view";
} else {
    $articleviewtext = "views";
}
    ...
    <article>
        ...
        <section id="review_page" class="grid_16">
            <p id="small_details">
                ...
                <small><b><?php echo $author . " / </b>" . date("D jS M Y", strtotime($createdate)); ?></small>
                <br>
                <small><span
                            id="displayviews"><?php echo $articleviews . " " . $articleviewtext; ?></span><?php echo " <b> / </b> " . $bitecount . " " . $bitecounttext; ?>
                </small>
            </p>
            ...
            <p class="content" id="storyline_section">
                ...
                <?php echo html_entity_decode($storyline, ENT_QUOTES); ?>
            </p>
            <p class="content" id="gameplay_section">
                <span class="title">GAMEPLAY</span>
                <?php echo html_entity_decode($gameplay); ?>
            </p>

            <p class="content" id="gameplay_section">
                <span class="title">GRAPHICS</span>
                <?php echo html_entity_decode($graphics); ?>
            </p>
            <p class="content" id="gameplay_section">
                <span class="title">AUDIO</span>
                <?php echo html_entity_decode($audio); ?>
            </p>
            <p class="content" id="verdict_section">
                <span class="title">VERDICT</span>
                <?php echo html_entity_decode($verdict); ?>
            </p>
            ...
            <p class="content" id="author_section">
                ...
                <img src="imgs/users/<?php echo $arow_img; ?>-116x135.jpg"
                     title="Profile picture of <?php echo $author; ?>">
            ...
            <div class="comment_section"><a style="float:right;" id="disqus-help" class="help-link" href="#">What's
                    This?</a>
        ...
        <aside id="review_details" class="grid_8 grid_0">
            <h4>RATING</h4>
            <div id="allratings">
                <div class="smallrating" id="graphics_rating"><?php echo $graphics_rating; ?> <span>GRAPHICS</span>
                </div>
                <div class="smallrating" id="gameplay_rating"><?php echo $gameplay_rating; ?> <span>GAMEPLAY</span>
                </div>
                <div class="smallrating" id="storyline_rating"><?php echo $storyline_rating; ?> <span>STORYLINE</span>
                </div>
        ...
        <div id="image_holder" class="grid_4 grid_0">
            <a href="imgs/review/<?php echo $aimage; ?>"><img src="imgs/review/<?php echo $aimage; ?>" width="200"
                                                              height="100"></a>
            <a href="imgs/review/<?php echo $bimage; ?>"><img src="imgs/review/<?php echo $bimage; ?>" width="200"
                                                              height="100"></a>
            <a href="imgs/review/<?php echo $cimage; ?>"><img src="imgs/review/<?php echo $cimage; ?>" width="200"
                                                              height="100"></a>
            <a href="imgs/review/<?php echo $dimage; ?>"><img src="imgs/review/<?php echo $dimage; ?>" width="200"
                                                              height="100"></a>
            <a href="imgs/review/<?php echo $eimage; ?>"><img src="imgs/review/<?php echo $eimage; ?>" width="200"
                                                              height="100"></a>
