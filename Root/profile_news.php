...
$query_user_arts = "SELECT id, article_type, title, author, month, a_image, views, createdate, bites FROM tbl_news WHERE authuser = ? AND alpha_approved = 'true' ORDER BY " . $type . " ". $order ." LIMIT 9 OFFSET " .  $offset . ";";
