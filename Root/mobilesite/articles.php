    ...
    <div class="container">
        ...
        <div class="row white-page">
            <section id="main_featured_article">
                ...
                <img src="http://gamesharkreviews.com/imgs/review/<?php echo urlencode($mainfeatROW['a_image']); ?>">
                <a href="<?php echo $mainfeatURL; ?>" title="<?php echo $mainfeatROW['title']; ?>"></a>
                <h3 class="main_featured_article_banner"><abbr title="Game Shark Reviews">GSR</abbr> ARTICLES</h3>
            </section>
...
<script type="text/javascript">
    ...
    function reImage() {
        $(".article_item").each(function() {
            $(this).children("#game_display").css("background", "url(http://gamesharkreviews.com/imgs/"+$(this).attr("data-article-type")+"/" + $(this).attr("data-article-image") + ") no-repeat top right");
            $(this).children("#game_type").css("background", "url(http://gamesharkreviews.com/imgs/"+$(this).attr("data-article-type")+"/" + $(this).attr("data-article-image") + ") no-repeat top left");
        });
    }
</script>
