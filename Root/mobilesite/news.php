...
while ($tROW = mysqli_fetch_array($tQUERY)) {
    ...
    $url = "http://m.gamesharkreviews.com/news.php?t=" . str_replace(" ", "_", $title);
...
<head>
    ...
    <meta itemprop="image" content="http://gamesharkreviews.com/imgs/news piece/<?php echo $aimage; ?>">
    ...
    <div class="container">
        ...
        <div class="row white-page">
            ...
            <div class="col-lg-12">
                ...
                <img src="http://gamesharkreviews.com/imgs/news/<?php echo $aimage; ?>" class="img-responsive img-thumbnail">
                ...
                <div class="content well" id="main_section" style="margin:0px !important;">
                    <?php echo file_get_contents($file_main); ?>
                </div>
    ...
    $("#bite").click(function(){
        ...
        $.get("bite_action.php",
            ...
            function(data, status){
                ...
                ae8857b082115f203e8a5d23410461f7(50, articletype, articleid, "bite", "<h3>Article Bite!</h3> You have been rewarded %xp%xp<br />for biting this news piece.");
