				...
				<ul class="grid_6 grid_0" id="checklist">
					...
					<?php //} else {
						//if(has_perms("articlelist-approve")) { ?>
							...
							<label for="beta_notes">Directors Notes</label>
							<textarea class="notes" name="beta_notes" id="beta_notes" <?php //if(has_perms("articlelist-finalise")) { echo "disabled"; } ?>><?php echo $beta_notes; ?>
							</textarea>
							<?php //if(has_perms("articlelist-finalise")) { ?>
								<label for="alpha_notes">CEOs Notes</label>
