	...
	<div id="video-page" class="container_24">
		...
		<article>
			...
			<section class="grid_24">
				...
				<center style="padding:0px;margin:0px;width: 960px;height: 376px;">
<iframe width="960" height="376" src="https://www.youtube.com/embed/<?php echo $id;?>?rel=0&amp;showinfo=0&theme=light" frameborder="0" allowfullscreen></iframe>
				</center>
				</div>
			</section>
