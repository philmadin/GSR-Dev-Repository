<form class="grid_18 grid_0 submitform" id="submitopinion" method="get" action="" enctype="multipart/form-data">
	...
	<p class="scroll_section" id="articleopiniontitle_section">
		<label for="articleopiniontitle">Title</label>
		<input name="articleopiniontitle" class="form_box_right" id="articleopiniontitle" style="margin-right: 241px;width: 345px;" type="text" value="" type="text" value="" placeholder="Enter your article's title here..." required />
	</p>
...
<ul class="grid_6 grid_0" id="checklist">
	...
	<li class="check_btn" id="articleopiniontitle_button">TITLE</li>
