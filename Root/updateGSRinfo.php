<?php
    ...
    if(isset($_POST['upload'])) {
        ...
        if(empty($_FILES['sharkface']['name'])) {
            header("Location: settings.php?change_image=file_empty");
            die("NO FILE");
        }
        ...
        if($IMG_size > 1048576) {
            header("Location: settings.php?change_image=filesize_error");
            die("IMAGE TOO LARGE");
        }
        ...
        if($IMG_size_info) {
            ...
            header("Location: settings.php?change_image=file_invalid");
            die("FILE INVALID");
        }
        ...
        if($IMG_res) {
            ...
            if(imagejpeg($LRG_canvas, $LRG_save_folder, 100) && imagejpeg($SML_canvas, $SML_save_folder, 100)) {
                ...
                header("Location: settings.php?change_image=upload_successful");
            }
