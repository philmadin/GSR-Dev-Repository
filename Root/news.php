<?php
	...
	$news_title = mysqli_real_escape_string($con, str_replace("_", " ", $_GET['t']));
	...
	$tQUERY = mysqli_query($con, "SELECT * FROM tbl_news WHERE title = '$news_title'");
	...
	while ($tROW = mysqli_fetch_array($tQUERY)) {
		...
		$url = "http://gamesharkreviews.com/news.php?t=" . str_replace(" ", "_", $title);
...
<title><?php echo $title . " by " . $author . " | " . $gamename . " News Article"; ?> | GSR</title>
...
<meta itemprop="image" content="http://gamesharkreviews.com/imgs/news/<?php echo $aimage; ?>">
...
<meta property="og:image" content="http://gamesharkreviews.com/imgs/news/<?php echo $aimage; ?>" />
...
<meta name="twitter:image" content="http://gamesharkreviews.com/imgs/news/<?php echo $aimage; ?>" />
...
<script type="application/ld+json">
	...
	"image": [
	"http://gamesharkreviews.com/imgs/news/<?php echo $aimage; ?>",
	"http://gamesharkreviews.com/imgs/news/<?php echo $bimage; ?>",
	"http://gamesharkreviews.com/imgs/news/<?php echo $cimage; ?>",
	"http://gamesharkreviews.com/imgs/news/<?php echo $dimage; ?>",
	"http://gamesharkreviews.com/imgs/news/<?php echo $eimage; ?>"
	],
	...
	<div id="page" class="container_24">
		...
		<article>
			<section class="grid_24" id="review_feature_image">
				<img src="imgs/news/<?php echo $aimage; ?>">
				<div id="gradient"></div>
			...
			<section id="review_page" class="grid_16">
				...
				<br />
				<?php if(isset($trailer) && $trailer!=""){ ?>
					<h3 id="trailer_section"></h3>
			...
			<div id="image_holder" class="grid_4 grid_0">
				<a href="imgs/news/<?php echo $aimage; ?>"><img src="imgs/news/<?php echo $aimage; ?>" width="200" height="100"></a>
				<a href="imgs/news/<?php echo $bimage; ?>"><img src="imgs/news/<?php echo $bimage; ?>" width="200" height="100"></a>
				<a href="imgs/news/<?php echo $cimage; ?>"><img src="imgs/news/<?php echo $cimage; ?>" width="200" height="100"></a>
				<a href="imgs/news/<?php echo $dimage; ?>"><img src="imgs/news/<?php echo $dimage; ?>" width="200" height="100"></a>
				<a href="imgs/news/<?php echo $eimage; ?>"><img src="imgs/news/<?php echo $eimage; ?>" width="200" height="100"></a>

				<hr />
				<h4>Related News Articles</h4>
				<ul id="related-articles" style="display: block !important;">
					<?php foreach($related as $rel){
						$rel['url'] = "news.php?t=" . str_replace(" ", "_", $rel['title']);
						$rel['image'] = "imgs/news/".urlencode($rel['a_image']);
						?>
						<li>
	...
	<script type="text/javascript">
        ...
        $(".social_share_side a, .social_share_bottom a").click(function(e){
            ...
            ae8857b082115f203e8a5d23410461f7(50, articletype, articleid, actionType, "<h3>Article Share!</h3> You have been rewarded %xp%xp<br />for sharing this news article.");
        });
    ...
    function(data, status){
		...
		console.log(status);
		setTimeout(function(){
			ae8857b082115f203e8a5d23410461f7(150, articletype, articleid, "view", "<h3>Article View!</h3> You have been rewarded %xp%xp<br />for reading this news article.");
		}, 30000);
    });
});
...
$("#bite").click(function(){
    ...
    function(data, status){
        ...
        ae8857b082115f203e8a5d23410461f7(50, articletype, articleid, "bite", "<h3>Article Bite!</h3> You have been rewarded %xp%xp<br />for biting this news article.");
