...
<head>
    ...
    <title>Dashboard | Add Game | GSR</title>

    <meta name="description" content="Submission form to add a game to GSR's database.">
        ...
        <section id="articlelist">
            ...
            <div id="db-main">
                ...
                <form class="wiki-form" id="add-game" method="post" action="manage-games_get.php?action=addgame" enctype="multipart/form-data">
                    ...
                    <textarea id="storyline" name="storyline" placeholder="Storyline"></textarea>

                    <label for="about">About</label>
                    <textarea id="about" name="about" placeholder="About the game"></textarea>

                    <div id="characters-load"></div>

                    <label for="release-date">Release Date</label>
                    <input type="text" name="release-date" id="release-date" placeholder="Select date which game was first release" />

                    <label for="website">Website</label>
                    <input type="url" name="website" id="website" placeholder="The game's website URL. " />
                    ...
                    <div class="container">
                        ...
                        while ($genre = mysqli_fetch_assoc($get_genres)) { ?>
                            ...
                            <input type="checkbox" id="genre-<?php echo $genre['id'];?>" name="genres[]" value="<?php echo $genre['id'];?>" /><label for="genre-<?php echo $genre['id'];?>"><?php echo $genre['genre'];?></label><br />
                            </div>
                        <?php } ?>
                    </div>
                    ...
                    <textarea id="levels" name="levels" placeholder="Levels"></textarea>

                    <label for="missions">Missions</label>
                    <textarea id="missions" name="missions" placeholder="Missions"></textarea>

                    <label for="weapons">Weapons</label>
                    <textarea id="weapons" name="weapons" placeholder="Weapons"></textarea>

                    <label for="cheats">Cheats</label>
                    <textarea id="cheats" name="cheats" placeholder="Cheats"></textarea>

                        <br /><br />
                        <button type="submit">Add Game</button><span class="error-result"></span>
...
<script>
    ...
    function loadType(x){
        $("#"+x+"-load").load("forms/game_"+x+".php", function(){loadTypes();scrollToBot();});
    }
    ...
    $(function() {
        ...
        $("#submitNewCharacter").click(function(e){
            ...
            $("#add-game").on("submit", function(e) {
                ...
                $.ajax({
                    url: "manage-games_get.php?action=addgame",
                    type: "post",
                    data: $(this).serialize(),
                    success: function(data) {
                        var result = data.split("@##$^@");
                        if(result[0]=="true"){
                            document.location="manage-games.php?game=submitted";
                        }
                        else{
                            var errors = result[1].split(",")[0];
                            erdiv.html("<br />"+errors);
