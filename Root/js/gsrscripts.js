...
$(document).ready(function() {
  ...
  $(".sharkcover").each(function() {
    if($(this).attr('data-cover-picture') == "default_cover") {
      $(this).css("background-image", "url(imgs/users/default_cover.jpg)");
    } else {
      $(this).css("background-image", "url(imgs/users/" + $(this).attr('data-cover-picture') + "-851x315.jpg)");
    }
  });
